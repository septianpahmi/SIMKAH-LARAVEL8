                ...
                <div class="card-body">
                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <nav aria-label="...">
                            <ul class="pagination">
                              <li class="page-item"><a class="page-link">ISTRI</a></li>
                              <li class="page-item active" aria-current="page">
                                <span class="page-link">AYAH ISTRI</span>
                              </li>
                              <li class="page-item"><a class="page-link">IBU ISTRI</a></li>
                            </ul>
                          </nav><!-- End Small Sizing -->
        
                      <!-- Multi Columns Form -->
                      <form action="{{url('/home/daftar-nikah/calon-istri/ibu-istri')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-2">

                    ...
                    <div class="card-body">
                        ...
                        <nav aria-label="...">
                            <ul class="pagination">
                              ...
                              <li class="page-item active" aria-current="page">
                                <span class="page-link">AYAH SUAMI</span>
                              </li>
                              <li class="page-item"><a class="page-link">IBU SUAMI</a></li>
                            </ul>
                          </nav><!-- End Small Sizing -->
        
                      <!-- Multi Columns Form -->
                      <form action="{{url('/home/daftar-nikah/calon-suami/ibu-suami')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-2">

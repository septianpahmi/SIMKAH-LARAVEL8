                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item active" aria-current="page">
                        <span class="page-link">4. CALON ISTRI</span>
                      </li>
                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <nav aria-label="...">
                            <ul class="pagination">
                              <li class="page-item active" aria-current="page">
                                <span class="page-link">ISTRI</span>
                              </li>
                              <li class="page-item"><a class="page-link" href="#">AYAH ISTRI</a></li>
                              <li class="page-item"><a class="page-link" href="#">IBU ISTRI</a></li>
                            </ul>
                          </nav><!-- End Small Sizing -->
        
                      <!-- Multi Columns Form -->
                      <form action="{{url('/home/daftar-nikah/calon-istri/ayah-istri')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-2">
                        ...
                        <div class="col-12">
                            <label for="foto" class="form-label">Upload Foto Ukura 2x3 Dengan Background Biru dan ukuran maximal file 500KB format JPG/PNG</label>
